...
public class ModEMIClientPlugin implements EmiPlugin {
    ...
    public static final EmiRecipeCategory SCUTCHING_CATEGORY = new EmiRecipeCategory(new Identifier(ArmorRestitched.MOD_ID, "scutching"), SCUTCHER,
            new EmiTexture(new Identifier(ArmorRestitched.MOD_ID, "textures/emi/gui/emi_scutching.png"), 0, 0, 16, 16));
