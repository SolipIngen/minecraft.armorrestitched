...
public class EMIScutchingRecipe implements EmiRecipe {
    ...
    public Identifier getId() {
        ...
        return potionOptional.map(potionEntry -> Identifier.of(ArmorRestitched.MOD_ID, this.output.getId().getPath() + "_scutching")).orElse(null);
    }
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addTexture(new EmiTexture(Identifier.of(ArmorRestitched.MOD_ID, "textures/emi/gui/emi_scutching.png"), 16, 0, 16, 16), 4, 25);
