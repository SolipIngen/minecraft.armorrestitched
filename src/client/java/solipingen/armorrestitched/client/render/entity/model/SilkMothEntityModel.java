...
public class SilkMothEntityModel extends EntityModel<SilkMothEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.RIGHT_WING, ModelPartBuilder.create().uv(40, 2).cuboid(-12.0f, -14.0f, 4.0f, 12.0f, 8.0f, 0.0f), ModelTransform.NONE);
        modelPartData.addChild(EntityModelPartNames.LEFT_WING, ModelPartBuilder.create().uv(40, 2).mirrored().cuboid(0.0f, -14.0f, 4.0f, 12.0f, 8.0f, 0.0f), ModelTransform.NONE);
        ...
        return TexturedModelData.of(modelData, 64, 64).transform(ModelTransformer.scaling(0.2f));
    }
...
//    }
    ...
    @Override
    public void setAngles(SilkMothEntityRenderState renderState) {
        this.body.pitch = 1.0472f + MathHelper.cos(renderState.age*0.1f)*0.15f;
        this.body.yaw = 0.0f;
        ...
        this.rightWing.yaw = this.body.yaw;
        this.leftWing.yaw = this.body.yaw;
        this.rightWing.roll = MathHelper.cos(0.75f*renderState.age*74.48451f*((float)Math.PI / 180))*(float)Math.PI*0.25f;
