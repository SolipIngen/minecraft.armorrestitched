...
public class ModEntityModelLayers {
    ...
    public static final EntityModelLayer ELYTA_TRIM_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "elytra_trim"), "main");

    public static final EntityModelLayer ILLAGER_INNER_ARMOR_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "illager_inner_armor"), "main");
    public static final EntityModelLayer ILLAGER_OUTER_ARMOR_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "illager_outer_armor"), "main");

    public static final EntityModelLayer VILLAGER_INNER_ARMOR_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "villager_inner_armor"), "main");
    public static final EntityModelLayer VILLAGER_OUTER_ARMOR_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "villager_outer_armor"), "main");

    public static final EntityModelLayer SILK_MOTH_LAYER = new EntityModelLayer(Identifier.of(ArmorRestitched.MOD_ID, "silk_moth"), "main");
