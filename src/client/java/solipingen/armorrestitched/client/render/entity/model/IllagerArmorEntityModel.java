...
public class IllagerArmorEntityModel<T extends IllagerEntity> extends SinglePartEntityModel<T> implements ModelWithArms, ModelWithHead {
    ...
    public void setAngles(T illagerEntity, float f, float g, float h, float i, float j) {
        ...
        if (this.riding) {
            ...
            this.rightArm.pitch = MathHelper.cos(0.6662f*f + (float)Math.PI)*2.0f*g*0.5f;
            this.rightArm.yaw = 0.0f;
            this.rightArm.roll = 0.0f;
            this.leftArm.pitch = MathHelper.cos(0.6662f*f)*2.0f*g*0.5f;
            this.leftArm.yaw = 0.0f;
            this.leftArm.roll = 0.0f;
        ...
        if (state == IllagerEntity.State.ATTACKING) {
            ...
            this.rightArm.pitch = MathHelper.cos(0.6662f*h)*0.25f;
            this.leftArm.pitch = MathHelper.cos(0.6662f*h)*0.25f;
            ...
            this.rightArm.pivotZ = 0.0f;
            this.rightArm.pivotX = -5.0f;
            this.rightArm.pitch = MathHelper.cos(0.6662f*h)*0.05f;
            this.rightArm.roll = 2.670354f;
            this.rightArm.yaw = 0.0f;
            this.leftArm.pivotZ = 0.0f;
            this.leftArm.pivotX = 5.0f;
            this.leftArm.pitch = MathHelper.cos(0.6662f*h)*0.05f;
            this.leftArm.roll = -2.3561945f;
            this.leftArm.yaw = 0.0f;
        }
    ...
    public static TexturedModelData getLegsArmorTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(0, 16).cuboid(-2.0f, IllagerArmorEntityModel.getFreshLegsYCorrection(), -2.0f, 4.0f, 12.0f, 4.0f, INNER_DILATION.add(0.1f)), ModelTransform.pivot(-1.9f, 12.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 16).mirrored().cuboid(-2.0f, IllagerArmorEntityModel.getFreshLegsYCorrection(), -2.0f, 4.0f, 12.0f, 4.0f, INNER_DILATION.add(0.0997f)), ModelTransform.pivot(1.9f, 12.0f, 0.0f));
    ...
    public static TexturedModelData getHeadArmorTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(0, 16).cuboid(-2.0f, IllagerArmorEntityModel.getFreshLegsYCorrection(), -2.0f, 4.0f, 12.0f, 4.0f, OUTER_DILATION.add(0.1f)), ModelTransform.pivot(-1.9f, 12.0f, 0.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 16).mirrored().cuboid(-2.0f, IllagerArmorEntityModel.getFreshLegsYCorrection(), -2.0f, 4.0f, 12.0f, 4.0f, OUTER_DILATION.add(0.0997f)), ModelTransform.pivot(1.9f, 12.0f, 0.0f));
        return TexturedModelData.of(modelData, 64, 32);
    }
