...
public abstract class FoxEntityMixin extends AnimalEntity {
    ...
    public RegistryKey<LootTable> getLootTableId() {
        return switch (((FoxEntity)(Object)this).getVariant()) {
            case RED -> RegistryKey.of(RegistryKeys.LOOT_TABLE, new Identifier(ArmorRestitched.MOD_ID, "entities/fox/red"));
            case SNOW -> RegistryKey.of(RegistryKeys.LOOT_TABLE, new Identifier(ArmorRestitched.MOD_ID, "entities/fox/snow"));
