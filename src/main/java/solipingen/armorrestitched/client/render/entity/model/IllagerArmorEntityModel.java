...
public class IllagerArmorEntityModel<T extends IllagerEntity> extends SinglePartEntityModel<T> implements ModelWithHead {
    ...
    public static TexturedModelData getLegsArmorTexturedModelData() {
        ...
        modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(16, 16).cuboid(-4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f, INNER_DILATION.add(0.1f)), ModelTransform.NONE);
        ...
        modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 16).mirrored().cuboid(-2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, INNER_DILATION.add(0.1f)), ModelTransform.pivot(2.0f, 12.0f, 0.0f));
