...
public class ModBlocks {
    ...
    public static final Block MULBERRY_SAPLING = ModBlocks.registerBlock("mulberry_sapling", new SaplingBlock(ModSaplingGenerator.MULBERRY, AbstractBlock.Settings.copy(Blocks.OAK_SAPLING)), true);

    // Cotton & Flax
    public static final Block COTTON_FLOWER = ModBlocks.registerBlock("cotton_flower", new CottonFlowerBlock(StatusEffects.ABSORPTION, 8, AbstractBlock.Settings.copy(Blocks.CHERRY_SAPLING)), true);
    ...
    public static final Block POTTED_COTTON_FLOWER = ModBlocks.registerBlock("potted_cotton_flower", new FlowerPotBlock(COTTON_FLOWER, AbstractBlock.Settings.copy(Blocks.POTTED_CHERRY_SAPLING).breakInstantly().nonOpaque()), false);
    ...
    private static Block registerBlock(String name, Block block, boolean withBlockItem) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(ArmorRestitched.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, Identifier.of(ArmorRestitched.MOD_ID, name), new BlockItem(block, new Item.Settings()));
    }
