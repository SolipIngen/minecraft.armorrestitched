...
public class ModItemGroups {
    ...
    private static final Set<TagKey<Item>> modEnchantableTagsSet = Set.of(ModItemTags.BREACH_ENCHANTABLE, ModItemTags.ELYTRA_ENCHANTABLE);
    ...
    public static void registerModItemsToVanillaGroups() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> entries.add(ModItems.FLAXSEEDS));
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> entries.add(ModItems.FLAXSEEDS));
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> entries.add(ModItems.FLAX_STRAW));
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.SPAWN_EGGS).register(entries -> entries.add(ModItems.SILK_MOTH_SPAWN_EGG));
