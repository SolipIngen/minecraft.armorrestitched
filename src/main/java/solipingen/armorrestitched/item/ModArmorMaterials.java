...
public class ModArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> COTTON = ModArmorMaterials.register("cotton", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 3);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "cotton"), "", true), new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "cotton"), "_overlay", false)));
    public static final RegistryEntry<ArmorMaterial> FUR = ModArmorMaterials.register("fur", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 3);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "fur"), "", true), new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "fur"), "_overlay", false)));
    public static final RegistryEntry<ArmorMaterial> LINEN = ModArmorMaterials.register("linen", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 3);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "linen"), "", true), new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "linen"), "_overlay", false)));
    ...
    public static final RegistryEntry<ArmorMaterial> WOOL = ModArmorMaterials.register("wool", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 3);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "wool"), "", true), new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "wool"), "_overlay", false)));
    public static final RegistryEntry<ArmorMaterial> PAPER = ModArmorMaterials.register("paper", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 3);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "paper"), "", true), new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, "paper"), "_overlay", false)));
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(new Identifier(ArmorRestitched.MOD_ID, id)));
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient, List<ArmorMaterial.Layer> layers) {
        ...
        return Registry.registerReference(Registries.ARMOR_MATERIAL, new Identifier(ArmorRestitched.MOD_ID, id),
